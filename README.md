...
Windows単独版、macOS版、Linux（GNOME / Raspberry Pi labwc）版の公式サポートリポジトリです。
...
このリポジトリは配布後のマニュアルとサポート窓口を公開するためのもので、Spatial Wall本体のソースコードは含みません。単独版は有償のクローズドソースソフトウェアです。使用条件は[使用許諾契約書（日本語・正文）](legal/EULA.ja.txt)および[英語版](legal/EULA.en.txt)を参照してください。
